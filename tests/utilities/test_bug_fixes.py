...
try:
    # Test new version (cnn_optimizer)
    ...
    # Test old version (should delegate to new one with deprecation warning)
    import warnings
    from training.optimizers import create_optimizer as old_create_optimizer
