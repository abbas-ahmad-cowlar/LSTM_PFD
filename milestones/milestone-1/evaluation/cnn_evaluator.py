...
class CNNEvaluator:
    ...
    def analyze_failures(
        ...
        Args:
            ...
            num_cases: Number of specific failure cases to return
        ...
        class_names = class_names or self.class_names or [str(i) for i in range(NUM_CLASSES)]

        with torch.no_grad():
            for signals, labels in tqdm(test_loader, desc="Analyzing Failures"):
                signals = signals.to(self.device)
                ...
                for i in range(batch_size):
                    ...
                    if true_label != pred_label:
                        ...
                        # Track confused pairs
                        pair = (true_label, pred_label)
                        confused_pairs[pair] = confused_pairs.get(pair, 0) + 1
                        
                        # Store case details (limit number of stored cases)
        ...
        return {
            ...
            'error_rate': total_failures / total_samples if total_samples > 0 else 0,
            'most_confused_pairs': sorted_pairs,
