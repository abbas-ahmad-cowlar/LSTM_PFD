% ⚠️ UNVALIDATED DRAFT — contains invented results; do not cite or submit.
% Every reported number (98.1% accuracy, ablation deltas, per-class results,
% "domain expert validation") was written before any experiment was run.
% See audit_reports/PROJECT_AUDIT_2026-06-11.md §6. The real paper is written
% from scratch in Convergence Plan Phase 7, against results/ artifacts only.
%
