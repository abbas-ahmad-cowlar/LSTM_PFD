...
\label{sec:repro}
\textit{[TODO C5] \code{results/PROVENANCE_MANIFEST.md}; content hashes; the
Zenodo checkpoint archive (DOI pending --- ``will archive''); the independent
from-checkpoint reproduction (\code{audit_reports/...2026-06-24...}); hosting /
license (CC-BY-4.0) / maintenance plan; D\&B reproducibility checklist.}
